...
| 2026-09-24 | VP-003 shared dialog keyboard behavior | `npm run build`, `npm run test:unit`, `npm run test:e2e` | PASS — 161/161 unit, 69/69 E2E (5 static + 64 Chrome) | Modal dialogs receive accessible names/semantics, initial and contained keyboard focus, Escape cancellation and focus restoration. AT-53 checks client dialog behavior at 320/390/768 px and keyboard behavior in an unannotated New Job dialog. Every dialog’s save and individual dismissal paths remain open. |
