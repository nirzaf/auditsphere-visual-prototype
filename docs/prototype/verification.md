...
| 2026-09-24 | VP-013/014 job and task controls | `npm run lint`, `npm run test:unit`, `npm run test:e2e`, focused AT-11/12 Chrome | PASS — 145/145 unit, 63/63 E2E (5 static + 58 Chrome); AT-11/12 and AT-14 both pass | Chrome combines client/engagement/owner/status/overdue job filters; reasoned block and terminal cancellation preserve tasks, documents and time as read-only. Task title, description and due date edit in place; blocked status requires a reason; sibling order changes; assignment history survives detail edits and an independent reassignment. Parent completion and exactly-one-level subtask guards pass. AT-14 now targets its uniquely labeled internal-note edit control. VP-013/014 and Module 05 remain Partial for full job field editing, task comments/attachments, and job files/time detail tabs. |
