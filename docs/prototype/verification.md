...
| 2026-09-24 | `320618b3a4a19606d1e6fe3a2112be5ce01bde11` | VP-036 GL import, source revisions and opening-to-closing tie-out | PASS — `npm run lint`, `npm run test:unit` 167/167, and `npm run test:e2e` 71/71 (5 static + 66 Chrome). AT-36 imports a period-bound engagement GL source, checks the digest/revision, reconciles each TB account using explicit opening balances and movements, verifies filtered transaction drill-down, then reloads and confirms the source and complete tie-out persist. Unit tests cover real XLSX parsing, opening-only rows, unbalanced journals, duplicate line keys, wrong periods/currencies/dates, atomic rejection, immutable replacement history, unchanged TB rows, reconciliation staleness and fixture integrity. VP-036 remains Partial: user-configurable header mapping and broader partial-batch/output-rework matrices remain open. Cloudflare Pages deployment `0b725529-c89e-4dd9-8410-f179f469d60f` is Production on branch `production`, source `320618b`. The [immutable deployment](https://0b725529.steaudit-prototype.pages.dev) and [custom domain](https://prototype.steaudit.com) return HTTP 200; the JavaScript and CSS SHA-256 values match `dist` (`ce61e44c800725d9fd222399c930997c6a1b8404f2b986c71e0dee69138dec46` and `4fd2006049185501c7d65a4f9c16ef6e3b89d9ac634856733c4d842c496f550a`). |
