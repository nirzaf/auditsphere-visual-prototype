...
|---|---|---|---|---|
| 2026-09-24 | working tree after `3dbe195` | `npm run test:e2e` | PASS — 58/58 | VP-053 unlinks EVD-01 from PRC-02 with an attributed reason, confirms reassessment is required, then switches to the scoped client and confirms the shared bank statement remains visible while the internal workpaper and evidence-link identifiers remain hidden. Issued-package provenance after unlink remains open. |
