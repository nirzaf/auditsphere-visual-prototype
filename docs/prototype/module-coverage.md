...
| 12 | VP-028 | my-time | addTimeEntry/reviewTimeEntry/resubmitReturnedTime/correctApprovedTime | TIME-01…04 | submit→approve updates totals | self-approve denied | return/resubmit and approved correction preserve superseded revisions | Partial | AT-28 lifecycle has unit coverage; browser workflow not yet exercised; no auto-capture |
