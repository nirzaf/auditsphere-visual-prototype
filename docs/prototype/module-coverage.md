...
| 22 | VP-038 | accounting-setup | addAdjustmentJournal/updateAdjustmentJournal | AJ-01 | balanced, accepted and unreflected journals apply once | reflected or unapproved journal excluded; uncertain reflection blocks output | source rows remain unchanged; missing account codes block the journal | Partial | Full technical review, management decision and ledger posting workflow remains incomplete |
