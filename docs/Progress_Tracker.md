...
| Unit checks passing in this review | 199 / 199 | Fresh full local run on 2026-09-25; current uncommitted changes. |
| E2E checks passing in this review | 90 / 90 | Fresh full run 2026-09-25: 5 static + 85 Chrome checks; includes VP-025 no-access/pending-review and acknowledgement separation plus the portal identity/scope, sharing, client and staff-form journeys. |
...
| Open acceptance actions in Sections 9.3–9.4 | 69 | Recount of 84 evidence rows and 38 scope rows on 2026-09-25 finds 54 evidence/verification actions and 15 scope-reconciliation actions still pending or partial. Three “Verified subcase” evidence rows remain open because their actions are partial; completed queue actions are not story sign-offs. 48 stories remain Partial. Counts cover queue actions, not discovered GitHub issues. |
...
#### Pending actions
The distinction between implementation, evidence and scope reconciliation is intentional.
- [ ] **VP-039-E01 — Verification/evidence pending:** Passed subcases: timing arithmetic, nonzero residual approval block, out-of-scope schedule evidence rejection, unlinked proposed-correction rejection, independent approval after correction, returned-reason history across rework, and replacement of referenced DOC-002 stales the schedule while its Approved revision remains viewable. Exact test: `tests/e2e/app.test.ts::AT-39`; `tests/unit/guards.test.ts` VP-039 now also verifies missing item evidence blocks approval, alongside future-date and wrong-currency save rejection. Focused Chrome pass 1/1 and unit VP-039 pass on 2026-09-25. Remaining: broader currency/date/scope matrix, full criterion review and sign-off.
...
This queue contains **69 open planning actions** attached to the 48 Partial stories: 54 evidence/verification actions and 15 requirement/scope reconciliation actions. I recounted the 84 evidence rows and 38 scope rows in Sections 9.3–9.4 on 2026-09-25; “Verified subcase” rows with remaining work stay open. Current branch issues, PRs, assignees and due dates were not queried; link them before using this as a team execution board. No action is permission to merge or deploy.
...
| VP-003-E02 | [VP-003](#vp-003) | P1 | Extend registered dirty-form save/discard/cancel behavior to remaining forms; verify client/search, denied/restored direct targets. M365 setup passes route/persona/engagement cases. | Partial — guards cover selected proposal/billing/statements/packages/consolidation/planning/accounting/client/M365 drafts. Newly verified: adjustment untouched-vs-edited behavior; Communications email Stay/Discard; Time Tracking clean defaults, Stay, Discard without persistence, and Save before route change; Receivables receipt/allocation guards with client-switch Stay/Discard, route-change Discard and unchanged ledger; Documents and Workpapers upload Stay/Discard with no metadata/revision creation; Review Desk raise/response Stay/Discard with no note creation or response mutation; Release Completion dispatch and amendment drafts Stay/Discard without issuing or reopening; Jobs & Tasks new job/task/internal-note and job/task-edit/reassignment Stay/Discard with no unintended writes, plus job Save before route change. M365 dirty global search verifies cross-client ENG-26002 and destination route. Full E2E 89/89, 199/199 unit, lint/build/diff pass. Broader role/client/engagement/direct-target matrices and remaining modal families remain open, 2026-09-25 |
