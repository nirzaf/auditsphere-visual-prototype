...
| VP-003-AC02 | Given unsaved form changes, when navigating or switching persona/client, then the user can save, discard or cancel; drafts cannot accidentally save into the new context. | SUBCASES VERIFIED 2026-09-24: M365 setup Save persists before route change; Discard leaves stored config unchanged; Stay preserves the draft; route, persona, engagement and disconnect actions are guarded. Other forms, client/search changes and denied/restored targets remain open. |
