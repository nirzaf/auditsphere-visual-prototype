...
| Unit checks passing in this review | 168 / 168 | Fresh run on the current VP-036 column-mapping worktree; includes custom-header parsing, source-revision and migration-integrity checks. |
| E2E checks passing in this review | 71 / 71 | Fresh full Chrome run on the current VP-036 column-mapping worktree: 5 static checks + 66 actual Chrome checks, including manual GL header mapping, tie-out and reload persistence. |
