...
| VP-021-E01 | [VP-021](#vp-021) | P2 | Close wrong-root, inaccessible, unavailable/restore and linked-version cases for each original criterion and relevant record type. | Partial / AT-20 replacement/reassessment + VP-021 unavailable/restore Chrome; unit rejects outside-root/foreign-client move and inaccessible evidence use; 197 unit, 83 E2E, 2026-09-25; broader role/record-type matrix and sign-off remain |
