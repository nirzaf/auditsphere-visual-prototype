...
| Unit checks passing in this review | 203 / 203 | Fresh full local run on 2026-09-25; includes VP-031 invoice revision, reapproval, credit limits and scope guards. |
| E2E checks passing in this review | 92 / 92 | Fresh full run 2026-09-25: 5 static + 87 Chrome checks; includes AT-31 invoice revision and credit lineage. |
...
This queue contains **55 open planning actions** attached to the 48 Partial stories: 47 evidence/verification actions (29 Partial, 15 Pending, and 3 verified-subcase rows with explicit follow-up still open) and 8 requirement/scope reconciliation actions. I recounted the 84 evidence rows and 38 scope rows in Sections 9.3–9.4 on 2026-09-25. Current branch issues, PRs, assignees and due dates were not queried; link them before using this as a team execution board. No action is permission to merge or deploy.
