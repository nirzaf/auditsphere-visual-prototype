...
| VP-031-E01 | [VP-031](#vp-031) | P1 | Complete revision-bound return/edit/reapproval, draft cancellation versus issued correction, remaining-credit caps and cross-client/currency negative paths. | Partial / AT-31 verifies approved ad-hoc invoice revision 1→2, retained old snapshot/reviewer, cleared approval and fresh independent approval; issued credit remains linked to the immutable invoice face amount and does not move money. Creator self-approval, reasoned return/revision/reapproval and unit over-cap/cross-client/cross-currency guards pass. Source-linked invoice edit and full dates/references/criterion matrix remain open, 2026-09-25 |
