...
| VP-020-E02 | [VP-020](#vp-020) | P2 | Verify independent library access and cross-links to jobs/PBC/workpapers use the same logical document. | Complete / AT-20 direct library open + PBC-02/JOB-2602/WP-A1 navigation; each destination resolves the exact linked record and retains DOC-002 identity; full E2E 83/83, 2026-09-25 |
