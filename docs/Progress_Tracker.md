...
#### Pending actions
The distinction between implementation, evidence and scope reconciliation is intentional.
- [ ] **VP-003-E01 — Partial verification evidence:** Shared semantics, focus containment, Escape, Enter submission and focus restoration pass for selected client/New Job dialogs. Chrome now also verifies client-profile Cancel and backdrop dismissal discard the draft and restore focus, and New Job Cancel/backdrop dismissal discard the draft, restore focus and reopen cleanly (AT-53, 2026-09-25). Client edit focus restoration also passes (AT-05/AT-06). AT-26 confirms simulated-compose Cancel/backdrop dismissal discard drafts without persisting a communication and restore opener focus; AT-14 confirms Internal Note Cancel/backdrop dismissal discard drafts without adding a comment and restore opener focus (2026-09-25). Dialog-specific save/cancel/dismissal paths for the rest of the active-modal inventory and criterion sign-off remain open.
...
| VP-003-E01 | [VP-003](#vp-003) | P1 | Exercise dialog-specific save/cancel and dismissal paths for every active modal; shared keyboard behavior including Enter submission is tested for client and New Job dialogs. | Partial / lint, build, 183/183 unit, full E2E 78/78 (5 static + 73 Chrome); AT-53 covers client-profile Cancel/backdrop and New Job Cancel/backdrop, draft discard and focus return; AT-26 additionally verifies Compose Email and AT-14 Internal Note Cancel/backdrop dismissal, draft non-persistence and opener focus restoration; other modal-specific close paths remain open; latest full E2E 83/83 and unit 197/197, 2026-09-25 |
