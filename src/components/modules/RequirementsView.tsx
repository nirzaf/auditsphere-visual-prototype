...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-047', title: 'Complete client evaluation, conditions and manual continuance', moduleId: '27', moduleName: 'Client Acceptance', route: 'onboarding', status: 'Partial', criteriaSummary: 'Evaluation questionnaires with per-check evidence references; compliance recommendation; independent partner decision with rationale.' },
