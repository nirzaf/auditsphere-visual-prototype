...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '14', module: 'Billing & Invoicing', stories: 'VP-030, VP-031', route: 'billing', status: 'Partial', notes: 'Chrome verifies self-review denial, separate invoice/credit approval and issuance, and remaining balance; approved-source billing remains incomplete.' },
