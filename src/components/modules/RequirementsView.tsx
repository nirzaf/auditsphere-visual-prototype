...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-043', title: 'Create consolidation groups and effective perimeters', moduleId: '26', moduleName: 'Consolidation', route: 'consolidation', status: 'Partial', criteriaSummary: 'Supported profile is one Parent and one wholly owned Subsidiary with pinned components; unsupported ownership methods show no result.' },
