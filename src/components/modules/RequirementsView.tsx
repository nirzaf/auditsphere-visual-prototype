...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '14', module: 'Billing & Invoicing', stories: 'VP-030, VP-031', route: 'billing', status: 'Partial', notes: 'Chrome drafts from approved billable time at its pinned rate and reserves each source once; fixed-service billing and independent invoice/credit decisions remain covered by separate checks.' },
...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-030', title: 'Complete billing accounts and invoice drafting from explicit sources', moduleId: '14', moduleName: 'Billing & Invoicing', route: 'billing', status: 'Partial', criteriaSummary: 'Approved time invoices use pinned rates and reserve sources once; fixed-service milestone sources remain incomplete.' },
