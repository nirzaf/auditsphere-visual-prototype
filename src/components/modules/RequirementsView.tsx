...
const MODULE_ROWS: ModuleRow[] = [
  { moduleId: '01', module: 'Practice Dashboard', stories: 'VP-005, VP-060', route: 'overview', status: 'Partial', notes: 'Chrome verifies grant-scoped portfolio, counts, selected-engagement attention, activity and shared as-of date; selectable as-of drill-down and overdue metrics remain incomplete. VP-060 is verified in Reports.' },
...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-013', title: 'Add the simple job register and job detail workspace', moduleId: '05', moduleName: 'Jobs & Tasks', route: 'jobs', status: 'Partial', criteriaSummary: 'Chrome verifies combined client, engagement, owner, status and overdue filters, manual reasoned status changes and terminal cancellation with retained records. Full job field editing and files/time detail tabs remain.' },
