...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '31', module: 'Populations & Sampling', stories: 'VP-051', route: 'sampling', status: 'Partial', notes: 'Engagement-scoped selection and persisted per-item results; full source replacement history remains incomplete.' },
...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-051', title: 'Complete populations, manual sample selection and test results', moduleId: '31', moduleName: 'Sampling', route: 'sampling', status: 'Partial', criteriaSummary: 'Engagement-scoped manual selection and persisted item results; source replacement/reselection remains incomplete.' },
