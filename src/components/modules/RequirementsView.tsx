...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '04', module: 'Proposals & Engagements', stories: 'VP-010, VP-011, VP-012', route: 'proposals', status: 'Partial', notes: 'Chrome covers proposal draft/review/response, activation, and reasoned suspend/resume/cancel with retained history. Full scope/period/team editing and affected-review applicability remain incomplete.' },
...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-012', title: 'Complete engagement creation and lifecycle handoff', moduleId: '04', moduleName: 'Proposals & Engagements', route: 'engagements', status: 'Partial', criteriaSummary: 'Acceptance-gated professional work; reasoned suspend/resume/cancel/close with immutable terminal states; scope/period/team editing and applicability history.' },
