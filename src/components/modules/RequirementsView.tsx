...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '06', module: 'Job Templates', stories: 'VP-015', route: 'job-templates', status: 'Partial', notes: 'Chrome verifies explicit published-template application creates a fresh job/task tree with reset work states; revision and duplicate-click recovery remain incomplete.' },
  { moduleId: '07', module: 'Team Collaboration', stories: 'VP-016, VP-027', route: 'communications', status: 'Partial', notes: 'Chrome covers scope-bound internal job notes and local staff mentions; ordinary comment edit history and notification inbox remain incomplete.' },
