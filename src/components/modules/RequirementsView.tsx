...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-049', title: 'Add editable risks, audit programs and procedure linkage', moduleId: '29', moduleName: 'Risks & Programs', route: 'audit-risks', status: 'Partial', criteriaSummary: 'Engagement-scoped editable risk registers with assertion mapping and reciprocal risk/procedure links; reusable program templates and full revision/rework paths remain incomplete.' },
