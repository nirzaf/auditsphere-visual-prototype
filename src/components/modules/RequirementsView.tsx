...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '31', module: 'Populations & Sampling', stories: 'VP-051', route: 'sampling', status: 'Partial', notes: 'CSV/XLSX source import, SHA-256 revision history, fresh selection and persisted test results; assurance inference remains out of scope.' },
...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-051', title: 'Complete populations, manual sample selection and test results', moduleId: '31', moduleName: 'Sampling', route: 'sampling', status: 'Partial', criteriaSummary: 'Engagement-scoped CSV/XLSX population revisions, digest history, fresh manual reselection and persisted test results; assurance inference is not claimed.' },
