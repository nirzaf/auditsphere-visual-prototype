...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '10', module: 'Document Management', stories: 'VP-020, VP-021', route: 'documents', status: 'Partial', notes: 'Chrome verifies selected-file metadata persists after reload, originals are not stored, and evidence pins survive replacement; dependent reassessment remains manual.' },
...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-021', title: 'Add document versions, existing-file linking and optional OneDrive selection', moduleId: '10', moduleName: 'Document Management', route: 'documents', status: 'Partial', criteriaSummary: 'Chrome verifies the old pin, replacement adequacy review, current-version procedure link, fieldwork reassessment and independent re-clearance; original file bytes remain local and the dependent workpaper re-clearance path is unverified.' },
