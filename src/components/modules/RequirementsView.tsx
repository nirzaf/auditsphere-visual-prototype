...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-044', title: 'Select component packages and demonstrate currency translation', moduleId: '26', moduleName: 'Consolidation', route: 'consolidation', status: 'Partial', criteriaSummary: 'AT-44 verifies stale-pin warnings, explicit re-pin, and per-account FX/rounding trace; reporting-basis and package-review gates remain open.' },
