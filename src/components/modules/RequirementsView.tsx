...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '04', module: 'Proposals & Engagements', stories: 'VP-010, VP-011, VP-012', route: 'proposals', status: 'Partial', notes: 'Chrome covers proposal draft/review/response, activation, scoped due-date/team edits, and reasoned suspend/resume/cancel with retained history. Service/period editing and affected-review applicability remain incomplete.' },
