...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '05', module: 'Jobs & Tasks', stories: 'VP-013, VP-014', route: 'jobs', status: 'Partial', notes: 'Chrome covers blocked parent completion, real reassignment history and narrow-grant filtering of sibling jobs/tasks; unit tests cover nesting/job-scope guards.' },
