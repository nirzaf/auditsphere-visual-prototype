...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '19', module: 'Identity & Access Management', stories: 'VP-018, VP-019', route: 'administration', status: 'Partial', notes: 'Simulated identities; explicit scoped grants; append-only grant/revocation actor, scope, time and reason history.' },
  ...
  { moduleId: '29', module: 'Risks & Audit Programs', stories: 'VP-049', route: 'audit-risks', status: 'Partial', notes: 'Engagement-scoped editable risk register and reciprocal risk/procedure links; reusable program templates remain incomplete.' },
