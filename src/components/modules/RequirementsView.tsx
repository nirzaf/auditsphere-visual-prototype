...
const STORY_ROWS: StoryRow[] = [
  ...
  { id: 'VP-049', title: 'Add editable risks, audit programs and procedure linkage', moduleId: '29', moduleName: 'Risks & Programs', route: 'audit-risks', status: 'Partial', criteriaSummary: 'Chrome verifies risk edits create a superseding audit-plan review revision and require procedure reassessment; reusable program templates retain and apply published v1/v2 without changing prior engagement work. Broader risk return/rework and reopen cases remain.' },
