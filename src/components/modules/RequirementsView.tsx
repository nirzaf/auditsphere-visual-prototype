...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { moduleId: '10', module: 'Document Management', stories: 'VP-020, VP-021', route: 'documents', status: 'Partial', notes: 'Chrome verifies optional OneDrive selection records local metadata under the SharePoint canonical hierarchy; evidence version replacement remains incomplete.' },
