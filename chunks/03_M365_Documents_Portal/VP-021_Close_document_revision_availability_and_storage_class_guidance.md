...
<!-- TASK_ACCEPTANCE -->
- [ ] Metadata-only records never offer a fake original download after reload.
- [ ] Durable PBC/generated artifacts are not incorrectly described as metadata-only.
- [ ] Old pins remain historical while new evidence requires review.
- [ ] No actual SharePoint move, callback or remote transfer is required for completion.
<!-- END_TASK_ACCEPTANCE -->
