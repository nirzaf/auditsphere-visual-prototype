...
| Browser / viewport / build | Chrome E2E + artifact/pbc storage-class inspection |
...
| Command / test / observed result | Metadata-only records offer no fake original download after reload; durable artifacts not described as metadata-only; old pins stay historical; no remote transfer |
| Output or screenshot / hash | PASS - 83/83 E2E incl. AT-41/42/48 (bytes re-verified after reload) and AT-23/24; README documents both storage classes; uploads must be reselected after reload by design |
